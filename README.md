...
Built by the team CodeCitadel, the project FixPilot at https://codecitadel-fixpilot.vercel.app/ is a FastAPI backend for a product support platform. It stores products locally, indexes product documentation into Moss, searches indexed knowledge, answers support questions with Gemini, and runs diagnostic sessions that narrow probable causes over follow-up answers.
